...
"""
def init():
	global LOCAL_PORT, NEIGHBOR_IP, NEIGHBOR_PORT, TTL, DEBUG_MODE, SENT_MESSAGE_IDS, RECV_MESSAGE_IDS, SUPER_PEER_PORT_BROADCAST, SUPER_PEER_ID, TOPOLOGY, BROADCAST_STATUS, LEAF_NODE_PORT, SUPER_PEER_LIST
