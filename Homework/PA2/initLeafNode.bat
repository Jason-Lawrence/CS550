@echo on
cd D:\Users\Jason\Documents\School\ComputerScience\CS550\Homework\PA2\tmp\PA2\LeafNode\bin
...
start ./main.py ..\conf\peer13.conf
start ./main.py ..\conf\peer14.conf
start ./main.py ..\conf\peer15.conf
start ./main.py ..\conf\peer16.conf
start ./main.py ..\conf\peer17.conf
start ./main.py ..\conf\peer18.conf
start ./main.py ..\conf\peer19.conf
pause