...
for x in range(20):
	...
	#os.mkdir(pathMaster)
	#os.mkdir(pathCache)
	config.write("MASTER_FILE_SPACE = C:\\Users\\Jason\\Desktop\\PA3\\LeafNode\\SharedSpace\\SharedSpace" + str(x) + "\\master\n")
	config.write("CACHE_FILE_SPACE = C:\\Users\\Jason\\Desktop\\PA3\\LeafNode\\SharedSpace\\SharedSpace" + str(x) + "\\cache\n")
